...
#python -u train.py --mode='finetune' --epochs=20 --numdepth=768 --trainviews=7 --testviews=7 --logdir $LOG_DIR --loadckpt $LOG_DIR_CKPT --dataset=blend --batch_size=4 --trainpath=$BLEND_TRAINING \
