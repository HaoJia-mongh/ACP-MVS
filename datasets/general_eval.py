...
class MVSDataset(Dataset):
    ...
    def build_list(self):
        ...
        for scan in scans:
            ...
            pair_file = "/data/jh/data/dtu/Cameras_effi/pair.txt"
            # read the pair file
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            proj_mat_filename = os.path.join(self.datapath, '/data/jh/data/dtu/Cameras_effi/test/{:0>8}_cam.txt'.format(vid))
